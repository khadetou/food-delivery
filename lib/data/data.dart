...
final _burrito = Food(
    imageUrl: '../../asset/images/burrito.jpg', name: 'Burrito', price: 8.99);
final _burger = Food(
    imageUrl: '../../asset/images/burger.jpg', name: 'Burger', price: 14.99);
final _pancakes = Food(
    imageUrl: '../../asset/images/pancakes.jpg', name: 'Pancakes', price: 9.99);
final _pasta =
...
final _salmon = Food(
    imageUrl: '../../asset/images/salmon.jpg',
    name: 'Salmon Salad',
    price: 12.99);
final _steak =
